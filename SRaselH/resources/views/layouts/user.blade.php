                ...
                <div style="background-color: #3e6562;" class="page-sidebar navbar-collapse collapse" >
                    ...
                    <ul style="background-color: #3e6562;" class="page-sidebar-menu  page-header-fixed "  data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="nav-item {{ Request::path() == 'users' ? 'active' : '' }}">
                                    <a  href="{{ URL::to('users') }}" class="nav-link ">
                                        <span class="title">StudentList</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li  class="nav-item {{ Request::path() == 'reports' ? 'active' : '' }}">
                            <a href="{{ URL::to('/reports') }}" class="nav-link">
                                <i class="fa fa-bar-chart"></i>
                                <span class="title">ReportList</span>
                                <span  class="selected"></span>
                            </a>
                        </li>
                    <?php }   ?>
                        <?php  if(Auth::user()->userType == 0){   ?>
                        <li  class="nav-item {{ Request::path() == 'reports/add' ? 'active' : '' }}">
                            <a href="{{ URL::to('reports/add') }}" class="nav-link">
                                <i class="fa fa-bar-chart"></i>
                   ...
                   <?php      } ?>
                        ...
                        <?php  if(Auth::user()->userType == 0){   ?>
                        <li  class="nav-item {{ Request::path() == 'buy_meal' ? 'active' : '' }}">
                            <a href="{{ URL::to('buy_meal') }}" class="nav-link">
                                <i class="fa fa-bar-chart"></i>
                                <span class="title">Buy Meal Token</span>
                                <span  class="selected"></span>
                            </a>
                        </li>
                        <?php      } ?>
                        ...
                        $members = array('set_token_date','token_list','update_meal_cost','turn_on_token_sell','turn_off_token_sell');
                        ?>
                        <li class="nav-item {{ in_array(Request::path(), $members) ? 'active' : '' }}">
                            <a  href="javascript:;" class="nav-link nav-toggle">
                                <i  class="fa fa-cog"></i>
                                <span  class="title">Meal System</span>
                                <span  class="arrow {{ in_array(Request::path(), $members) ? 'open' : '' }}"></span>
                            </a>
                            <ul class="sub-menu">
                                <li class="nav-item {{ Request::path() == 'set_token_date' ? 'active' : '' }}">
                                    <a  href="{{ URL::to('set_token_date') }}" class="nav-link ">
                                        <span class="title">Set Date Token</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::path() == 'token_list' ? 'active' : '' }}">
                                    <a  href="{{ URL::to('token_list') }}" class="nav-link ">
                                        <span class="title">Token List</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::path() == 'update_meal_cost' ? 'active' : '' }}">
                                    <a  href="{{ URL::to('update_meal_cost') }}" class="nav-link ">
                                        <span class="title">Update Meal Cost</span>
                                    </a>
                                </li>

                                <li class="nav-item {{ Request::path() == 'turn_on_token_sell' ? 'active' : '' }}">
                                    <a  href="{{ URL::to('turn_on_token_sell') }}" class="nav-link ">
                                        <span class="title">Turn On Token Sell</span>
                                    </a>
                                </li>

                                <li class="nav-item {{ Request::path() == 'turn_off_token_sell' ? 'active' : '' }}">
                                    <a  href="{{ URL::to('turn_off_token_sell') }}" class="nav-link ">
                                        <span class="title">Turn Off Token Sell</span>
                                    </a>
                                </li>
                        ...
                        <li class="nav-item {{ Request::path() == 'ex-import' ? 'active' : '' }}">
                            <a href="{{ URL::to('ex-import') }}" class="nav-link">
                        ...
                        $members = array('uDetails', 'userDetails/add');
                        ?>
                        <li class="nav-item {{ in_array(Request::path(), $members) ? 'active' : '' }}">
                            <a  href="javascript:;" class="nav-link nav-toggle">
                                <i  class="fa fa-user"></i>
                            ...
                            <ul  class="sub-menu">
                                <li  class="nav-item {{ Request::path() == 'userDetails/add' ? 'active' : '' }}">
                                    <a   href="{{ URL::to('userDetails/add') }}" class="nav-link ">
                                        <span  class="title">Add Primary Student</span>
                                    </a>
                                </li>
                                <li class="nav-item {{ Request::path() == 'uDetails' ? 'active' : '' }}">
                                    <a  href="{{ URL::to('uDetails') }}" class="nav-link ">
                                        <span class="title">Primary StudentList</span>
                                    </a>
                                </li>
                            </ul>
                        </li>
