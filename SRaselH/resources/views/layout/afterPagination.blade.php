...
<script src="{{asset('/logFolder/js/jquery.min.js')}}"></script>
<script src="{{asset('/logFolder/js/bootstrap.min.js')}}"></script>
<script src="{{asset('/logFolder/js/slick.min.js')}}"></script>
<script src="{{asset('/logFolder/js/nouislider.min.js')}}"></script>
<script src="{{asset('/logFolder/js/jquery.zoom.min.js')}}"></script>
<script src="{{asset('/logFolder/js/main.js')}}"></script>

<!-- jQuery Plugins end  logout  -->


<!--listShow/ table show javascript-->
<script src="{{asset('http://cdnjs.cloudflare.com/ajax/libs/respond.js/1.4.2/respond.js')}}"></script>
